...
const CreateUserPage = () => {
  ...
  const {search}=useLocation()
    ...
    const [name,setName]=useState(search&&user?user.name:"")
    const [email,setEmail]=useState(search&&user?user.email:"")
    const [phoneNumber,setPhone]=useState(search&&user?user.phoneNumber:"")
